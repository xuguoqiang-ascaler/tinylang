...
class Parser {
    ...
    bool parseImport();
    bool parseBlock(DecList &Decls, StmtList &Stmts);
    bool parseDeclaration(DecList &Decls);
    bool parseConstantDeclaration(DecList &Decls);
    bool parseVariableDeclaration(DecList &Decls);
    bool parseProcedureDeclaration(DecList &Decls);
    bool parseFormalParamaters(FormalParamList &Params, Decl *&RetType);
    bool parseFormalParamatersList(FormalParamList &Params);
    bool parseFormalParamater(FormalParamList &Params);
